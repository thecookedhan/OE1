...
class Individual:
    ...
    def decode(self, bounds: list[float], bits_per_variable: int) -> float:
        decimal_genome = []
    ...
    def evaluate(self, fitness_function, bounds: list[float], bits_per_variable: int):
...
class Population:
    ...
    def initialize(self, genome_length: int):
        self.clear()
